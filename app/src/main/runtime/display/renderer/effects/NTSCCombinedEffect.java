...
public class NTSCCombinedEffect extends Effect {
  ...
  protected ShaderMaterial createMaterial() {
    // Returns an instance of the inner class which extends ScreenMaterial and implements the
    // combined NTSC shader
  ...
  private class NTSCCombinedEffectMaterial extends ScreenMaterial {
    ...
    protected String getFragmentShader() {
      ...
      // This shader combines subtle warping, enhanced scanlines, and chromatic aberration for a
      // cohesive NTSC effect.
      ...
      return String.join(
          ...
          new CharSequence[] {
            ...
            "   vec3 finalColor;",
            "   finalColor.r = texture2D(screenTexture, uv + vec2(CHROMA_OFFSET, 0.0)).r;", // Red
            // shift
            "   finalColor.g = texture2D(screenTexture, uv + vec2(0.0, BLUR_RADIUS)).g;", // Slight
            // green
            // blur
            "   finalColor.b = texture2D(screenTexture, uv - vec2(CHROMA_OFFSET, 0.0)).b;", // Blue
            // shift
            "   return finalColor;",
            "}",
            ...
            "   vec3 col = texture2D(screenTexture, uv).rgb;",
            "   float scanline = abs(sin(uv.y * resolution.y * 2.0)) * SCANLINE_INTENSITY;", // Use
            // resolution.y for scanline density
            ...
            "   vec3 finalColor = mix(ntscColor, scanlineColor, 0.7);", // Blend with emphasis on
            // scanlines
